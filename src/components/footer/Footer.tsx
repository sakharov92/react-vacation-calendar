...
const FooterComponent: React.FC<{ datalist: Data | undefined, chosenDate: Date }> = ({datalist, chosenDate}) => {
    ...
    return (
        ...
        <div className="footer__inner">
          <div className="footer__title">{`${format(chosenDate, 'MMMM')} ${chosenDate.getFullYear()}`} teams Summary</div>
          <div className="footer__stat">
            ...
            <div className="footer__amount">
              ...
              <span className="usersAmount">1</span>
            </div>
            <div className="footer__percent">5%</div>
          </div>
        </div>
        </div>
      </div>
