...
export const CalendarTable: React.FC<{ chosenDate: Date, setFormState: Function, dataList: Data | undefined }> = ({chosenDate, setFormState, dataList}) => {
            ...
            <table className="calendar__table">
                ...
                <tr className="outputCalendar">
                    <td className="addVacationCell outputItem">
                        <button className="addVacationBtn" onClick={setFormState.bind(this, true)}>
                        <span>+
                    </span>
                            Add
                            Vacation
                    ...
                    {currentMonthObj.map((item, index) => {
                        let itemClasses = item.isDayOff ? "outputItem weekend" : "outputItem";
                        return (
                            <td key={"" + new Date().getMilliseconds() + index} className={itemClasses}>
                ...
                </thead>
                {
                    dataList?.teams.map((team, index) => {
                        return <Team key={"" + new Date() + index} team={team} dataList={dataList} date={chosenDate}/>
                    })
                }
            </table>
        </section>
